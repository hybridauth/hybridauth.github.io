<?php
    ...
    function generate()
    {
        $pages = array(
            ...
            'developer-ref-autoloading.html',
            'developer-ref-configuration.html',
            'developer-ref-user-authentication.html',
            'developer-ref-user-profile.html',
            'developer-ref-user-contacts.html',
            'developer-ref-user-status.html',
            'developer-ref-user-activity.html',
            'developer-ref-exceptions.html',
            'developer-ref-providers-apis.html',
            'developer-ref-extend-hybridauth.html',
            'developer-ref-migrating.html',
        );
        ...
        elseif( in_array( $basename, $pages ) )
        {
            $header = file_get_contents( 'common/header.html' );

            $markdown = file_get_contents( str_replace( '.html', '.md', $basename ) );

            $body = MarkdownExtra::defaultTransform( $markdown );

            $comments =  file_get_contents( 'common/comments.html' );

            $footer =  file_get_contents( 'common/footer.html' );
            
            if(in_array($basename, [ 'index.html', 'install.html', 'license.html', 'plugins.html', 'documentation.html', 'support.html', 'search.html', 'getinvolved.html', 'developer-ref-providers-apis.html', 'developer-ref-migrating.html']))
                $comments = '';

            $html = $header . $body . $comments . $footer ;
            ...
            $html = str_replace(
                ...
                array(
                    ...
                    $basename,
                    'https://hybridauth.github.io/' . $basename,
                ),
                $html
            );

            if(in_array($basename, [ 'providers.html'])){
                $html = str_replace(
                    array(
                        '[X]' ,
                    ),
                    array(
                        ' &nbsp; <i class="fa fa-check-square fa-2" aria-hidden="true" style="color:#21b2a6; font-size: 1.4em;"></i>',
                    ),
                    $html
                );
            }
        ...
        file_put_contents('output/'. $basename, $html);
    ...
    class MarkdownExtra extends Markdown {
        ...
        protected function _doFencedCodeBlocks_callback($matches) {
            ...
            $codeblock  = "<pre class=\"prettyprint linenums lang-php\">$codeblock</pre>"; //<
